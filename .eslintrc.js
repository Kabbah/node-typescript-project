module.exports = {
    ...
    rules: {
        ...
        "@typescript-eslint/naming-convention": [
            "warn",
            { selector: ["variable", "function", "parameter", "property", "parameterProperty", "method", "accessor"], format: ["camelCase"] },
            { selector: "typeLike", format: ["PascalCase"] },
            { selector: ["enumMember"], format: ["UPPER_CASE"] },
            { selector: ["variable"], modifiers: ["global", "const"], format: ["UPPER_CASE"] },
        ],
